...
```
## Bar Chart for Accommodation Type
```{r}
...
# Scatterplot: Nights Spent vs Total Expenditure
```{r}
# Create a scatterplot to visualize the relationship between nights spent and total expenditure
ggplot(tourism, aes(x = Nights_spent, y = Total_expenditure)) +
  geom_point() +
